    ...
    <body>
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="studentLevels.jsp">Mi aprendizaje</a>
                </li>
                <li>
                    <a href="#">Mi cuenta</a>
                </li>
                ...
                <s:div cssClass="container-fluid">
                    ...
                    <s:div cssClass="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="studentLevels.jsp">Mi aprendizaje</a>
                            </li>
                            <li class="nav-item">
                ...
                <s:div cssClass="carousel-inner">
                    <s:div cssClass="carousel-item active">
                        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img">
                            <rect width="100%" height="100%" fill="#9CEC5B"/>
                        </svg>
                    ...
                    <s:div cssClass="carousel-item">
                        ...
                        <s:div cssClass="container">
                            <s:div cssClass="carousel-caption text-left">
                                ...
                                <p><a class="btn btn-sm btn-primary" href="studentLevels.jsp" role="button">Ir</a></p>
                            </s:div>
                        </s:div>
                    </s:div>
                    <s:div cssClass="carousel-item">
                ...
                <s:div cssClass="row">
                    <s:div cssClass="col-lg-4 text-center">
                        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140">
                            ...
                            <rect width="100%" height="100%" fill="#9CEC5B"/>
                            <text x="50%" y="50%" fill="#9CEC5B" dy=".3em">140x140</text>
                        </svg>
                        <h2>Continuar aprendiendo</h2>
                        <p>Aquí puedes continuar con el curso disponible para tu nivel actual.</p>
                        <p><a class="btn btn-secondary" href="studentLevels.jsp" role="button">Aprender más &raquo;</a></p>
                    </s:div>
                    <!-- /.col-lg-4 -->
                    <s:div cssClass="col-lg-4 text-center">
                        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140">
                        ...
                        <h2>Mi progreso</h2>
                        <p>Aquí puedes ver estadistícas de tu progreso durante la realización de los diversos niveles</p>
                        <p><a class="btn btn-secondary" href="#" role="button">Aprender más &raquo;</a></p>
                    </s:div>
                    <!-- /.col-lg-4 -->
                    <s:div cssClass="col-lg-4 text-center">
                        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140">
                        ...
                        <h2>Mi grupo</h2>
                        <p>Aquí puedes ver los nombres y progreso de tus compañeros de grupo!</p>
                        <p><a class="btn btn-secondary" href="#" role="button">Aprender más &raquo;</a></p>
                    </s:div>
                    <!-- /.col-lg-4 -->
                </s:div>
