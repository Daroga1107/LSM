...
<html>
	<!-- Head  -->
	<head>
		<title>SAALSM - Administrador</title>
		<style>
			.bd-placeholder-img{
			font-size: 1.125rem;
			text-anchor: middle ;
						...
						<s:div cssClass="col-lg-4 text-center">
							<svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140">
								<title>Agregar usuarios</title>
                                                                <div style="text-align: center;">
                                                                    <img src="../img/signs/a.png" height="110" width="110" onmouseout="this.src='../img/signs/a.png';" onmouseover="this.src='../img/addUser.gif';" align="center"/>
                                                                </div>
							</svg>
						...
						<s:div cssClass="col-lg-4 text-center">
							<svg  class="rounded-circle static" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140">
								<title>Mi cuenta</title>
                                                                <div style="text-align: center;">
                                                                    <img src="../img/signs/m.png" height="110" width="110" onmouseout="this.src='../img/signs/m.png';" onmouseover="this.src='../img/myAccount.gif';" align="center"/>
                                                                </div>
							</svg>
							<h2>Mi cuenta</h2>
