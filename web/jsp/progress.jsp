...
<html>
	<!-- Head  -->
	<head>
		<title>SAALSM - Ver progreso</title>
		<style>
			.bd-placeholder-img{
			font-size: 1.125rem;
			text-anchor: middle ;
			...
			<s:div id="content">
				...
				<div align="center">
					<%                
						...
						rs=manejador.executeQuery("SELECT * FROM user WHERE role=3");
						out.println("<table class=\"table\"><tr><th scope=\"col\">#</th><th scope=\"col\">Nombre</h><th scope=\"col\">Contraseña</th><th scope=\"col\">Tipo</th><th scope=\"col\" colspan=\"2\" colspan=\"text-align: center\">Avance</th>");
						while(rs.next()){
						    out.println("<tr><td>"+rs.getString("user.idUser")+"</td><td>"+rs.getString("user.email")+"</td><td>"+rs.getString("user.password")+"</td><td>"+manejador.roleToString(rs.getString("user.role"))+"</td>"
						             +"<td><div class=\"progress progress-bar progress-bar-striped progress-bar-animated\" role=\"progressbar\"  aria-valuenow=\"25\" aria-valuemin=\"0\" aria-valuemax=\"100\" value=\"25%\">25%</div></td></tr>");
