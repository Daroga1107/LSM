...
<html>
    ...
    <body id="contenido">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                <s:div cssClass="container-fluid">
                    ...
                    <a id="sidebarCollapse" class="navbar-brand" href="#">
                        <img src="../../img/lsmlogo.png" width="30" height="30" class="d-inline-block align-top" alt="">
        ...
        <s:div id="content">
            ...
            <s:div cssClass="container marketing">
                ...
                <s:div cssClass="row" id="contenido">
                    <br>
                    <br>
                    <br>
                    <br>
    ...
    <script src="../../js/p5js/p5.dom.js"></script>
    <script src="../../js/p5js/p5.sound.js"></script>
