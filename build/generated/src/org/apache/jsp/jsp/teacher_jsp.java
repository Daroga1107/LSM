...
public final class teacher_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<!-- Head  -->\r\n");
      out.write("\t<head>\r\n");
      out.write("\t\t<title>SAALSM - Profesor</title>\r\n");
      out.write("\t\t<style>\r\n");
  ...
  private boolean _jspx_meth_s_div_11(javax.servlet.jsp.tagext.JspTag _jspx_th_s_div_10, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_s_div_11 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t<title>Ver módulos</title>\r\n");
        out.write("\t\t\t\t\t\t\t\t<div style=\"text-align: center;\">\r\n");
        out.write("                                                                    <img src=\"../img/signs/m.png\" height=\"110\" width=\"110\" onmouseout=\"this.src='../img/signs/m.png';\" onmouseover=\"this.src='../img/seeModules.gif';\" align=\"center\"/>\r\n");
        out.write("                                                                </div>\r\n");
        out.write("\t\t\t\t\t\t\t</svg>\r\n");
        out.write("\t\t\t\t\t\t\t<h2>Ver módulos</h2>\r\n");
        out.write("\t\t\t\t\t\t\t<p>Aquí puedes ver los módulos actualmente disponibles en la aplicación</p>\r\n");
        out.write("\t\t\t\t\t\t\t<p>\r\n");
        out.write("\t\t\t\t\t\t\t\t<a class=\"btn btn-primary\" href=\"availableModules.jsp\" role=\"button\"><i class=\"material-icons\">chevron_right</i></a>\r\n");
  ...
  private boolean _jspx_meth_s_div_12(javax.servlet.jsp.tagext.JspTag _jspx_th_s_div_10, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_s_div_12 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t<svg class=\"bd-placeholder-img rounded-circle\" width=\"140\" height=\"140\" xmlns=\"http://www.w3.org/2000/svg\" preserveAspectRatio=\"xMidYMid slice\" focusable=\"false\" role=\"img\" aria-label=\"Placeholder: 140x140\">\r\n");
        out.write("\t\t\t\t\t\t\t\t<title>Ver progreso</title>\r\n");
        out.write("\t\t\t\t\t\t\t\t<div style=\"text-align: center;\">\r\n");
        out.write("                                                                    <img src=\"../img/signs/p.png\" height=\"110\" width=\"110\" onmouseout=\"this.src='../img/signs/p.png';\" onmouseover=\"this.src='../img/watchProgress.gif';\" align=\"center\"/>\r\n");
        out.write("                                                                </div>\r\n");
        out.write("\t\t\t\t\t\t\t</svg>\r\n");
        out.write("\t\t\t\t\t\t\t<h2>Ver progreso</h2>\r\n");
        out.write("\t\t\t\t\t\t\t<p>Aquí puedes ver las estadistícas de tus grupos</p>\r\n");
        out.write("\t\t\t\t\t\t\t<p>\r\n");
        out.write("\t\t\t\t\t\t\t\t<a class=\"btn btn-primary\" href=\"progress.jsp\" role=\"button\"><i class=\"material-icons\">chevron_right</i></a>\r\n");
        out.write("\t\t\t\t\t\t\t\t<a class=\"btn btn-secondary\" href=\"#\" role=\"button\"><i class=\"material-icons md-inactive\">check</i></a>\r\n");
        out.write("\t\t\t\t\t\t\t</p>\r\n");
        out.write("\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_s_div_13(javax.servlet.jsp.tagext.JspTag _jspx_th_s_div_10, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_s_div_13 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t<title>Mis grupos</title>\r\n");
        out.write("\t\t\t\t\t\t\t\t<div style=\"text-align: center;\">\r\n");
        out.write("                                                                    <img src=\"../img/signs/g.png\" height=\"110\" width=\"110\" onmouseout=\"this.src='../img/signs/g.png';\" onmouseover=\"this.src='../img/myGroups.gif';\" align=\"center\"/>\r\n");
        out.write("                                                                </div>\r\n");
        out.write("\t\t\t\t\t\t\t</svg>\r\n");
        out.write("\t\t\t\t\t\t\t<h2>Mis grupos</h2>\r\n");
        out.write("\t\t\t\t\t\t\t<p>Aquí puedes consultar la información de tus grupos</p>\r\n");
        out.write("\t\t\t\t\t\t\t<p>\r\n");
        out.write("\t\t\t\t\t\t\t\t<a class=\"btn btn-primary\" href=\"myGroups.jsp\" role=\"button\"><i class=\"material-icons\">chevron_right</i></a>\r\n");
        out.write("\t\t\t\t\t\t\t\t<a class=\"btn btn-secondary\" href=\"#\" role=\"button\"><i class=\"material-icons md-inactive\">check</i></a>\r\n");
        out.write("\t\t\t\t\t\t\t</p>\r\n");
        out.write("\t\t\t\t\t\t");
