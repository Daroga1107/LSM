		...
		<s:div cssClass="wrapper">
			...
			<nav id="sidebar">
				...
				<ul class="list-unstyled CTAs">
					...
					<li>
						<a href="myInfoStudent.jsp" role="button">
					...
					<s:div cssClass="container-fluid">
						...
						<s:div cssClass="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="nav navbar-nav ml-auto">
								...
								<li class="nav-item">
									<a class="btn nav-link" href="myInfoStudent.jsp" role="button"><i class="material-icons fa fa-user-circle"></i>  Mi cuenta</a>
								</li>
								<li>
					...
					<s:div cssClass="row">
						<s:div cssClass="col-lg-4 text-center">
							<svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140">
								<title>Continuar aprendiendo</title>
                                                            <div style="text-align: center;">
                                                                <img src="../img/signs/c.png" height="110" width="110" onmouseout="this.src='../img/signs/c.png';" onmouseover="this.src='../img/keepLearning.gif';" align="center"/>
                                                            </div>
							</svg>
							<h2>Continuar aprendiendo</h2>
							<p>Aquí puedes continuar aprendiendo el Lenguaje de Señas Mexicano</p>
							<p>
								<a class="btn btn-primary" href="keepLearning.jsp" role="button"><i class="material-icons">chevron_right</i></a>
						...
						<s:div cssClass="col-lg-4 text-center">
							<svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140">
                                                            ...
                                                            <div style="text-align: center;">
                                                                <img src="../img/signs/p.png" height="110" width="110" onmouseout="this.src='../img/signs/p.png';" onmouseover="this.src='../img/myProgress.gif';" align="center"/>
                                                            </div>
							</svg>
							<h2>Mi progreso</h2>
							<p>Aquí puedes ver tu avance de aprendizaje</p>
							<p>
						...
						<s:div cssClass="col-lg-4 text-center">
							<svg  class="rounded-circle static" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140">
								<title>Mi grupo</title>
                                                            <div style="text-align: center;">
                                                                <img src="../img/signs/g.png" height="110" width="110" onmouseout="this.src='../img/signs/g.png';" onmouseover="this.src='../img/myGroup.gif';" align="center"/>
                                                            </div>
							</svg>
							<h2>Mi grupo</h2>
							<p>Aquí puedes ver la información de tu grupo</p>
							<p>
