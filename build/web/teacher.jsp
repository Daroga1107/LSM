            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                <s:div cssClass="container-fluid">
                    ...
                    <a id="sidebarCollapse" class="navbar-brand" href="#">
                        <img src="./img/applog.gif" width="30" height="30" class="d-inline-block align-top" alt="">
                    ...
                    <s:div cssClass="carousel-item active">
                        ...
                        <s:div cssClass="container">
                            <s:div cssClass="carousel-caption text-left">
                                <% String paramValue = ServletActionContext.getRequest().getParameter("username");%>
                                <h3> <%System.out.println(""+paramValue);%></h3>
            ...
            <s:div cssClass="container marketing">
                ...
                <s:div cssClass="row">
                    <s:div cssClass="col-lg-4 text-center">
                        ...
                        <h2>Ver módulos</h2>
                        <p>Aquí puedes ver los modulos actualmente disponibles</p>
                    ...
                    <s:div cssClass="col-lg-4 text-center">
                        ...
                        <h2>Ver progreso</h2>
                        <p>Aquí puedes ver estadistícas de tus grupos</p>
                        <p><a class="btn btn-secondary" href="#" role="button">Aprender más &raquo;</a></p>
                    </s:div>
                    <!-- /.col-lg-4 -->
                    <s:div cssClass="col-lg-4 text-center">
                        ...
                        <h2>Mis grupos</h2>
                        <p>Aquí puedes ver los nombres y progreso de tus alumnos!</p>
                        <p><a class="btn btn-secondary" href="#" role="button">Aprender más &raquo;</a></p>
                    </s:div>
                    <!-- /.col-lg-4 -->
                </s:div>
