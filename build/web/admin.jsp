            ...
            <s:div cssClass="container marketing">
                ...
                <s:div cssClass="row">
                    <s:div cssClass="col-lg-4 text-center">
                        ...
                        <p>Aquí puedes asignar permisos de profesor a aquellos usuarios que lo solicitaron</p>
                    ...
                    <s:div cssClass="col-lg-4 text-center">
                        ...
                        <h2>Ver usuarios</h2>
                        <p>Aquí puedes ver la información de los usuarios dados de alta</p>
                        <p><a class="btn btn-secondary" href="#" role="button">Aprender más &raquo;</a></p>
                    </s:div>
                    <!-- /.col-lg-4 -->
                    <s:div cssClass="col-lg-4 text-center">
